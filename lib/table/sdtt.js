...
class TsTableSdtt {
    ...
    decode() {
        ...
        for (let i = 0; i < objSdtt.num_of_contents; i++) {
            ...
            content.descriptors = new descriptors_1.default(reader.readBytesRaw(content.content_description_length - content.schedule_description_length)).decode();
...
exports.default = TsTableSdtt;
//# sourceMappingURL=sdtt.js.map