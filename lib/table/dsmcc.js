...
const compatibility_1 = require("../descriptor/compatibility");
...
class TsDsmccMessageDownloadInfoIndication {
    ...
    decode() {
        ...
        objDii.compatibilityDescriptor = new compatibility_1.default(reader.readBytesRaw(2 + descriptorLength)).decode();
        ...
        for (let i = 0; i < objDii.numberOfModules; i++) {
            ...
            module.moduleInfo = new module_descriptors_1.default(reader.readBytesRaw(module.moduleInfoLength)).decode();
            objDii.modules.push(module);
        }
        objDii.privateDataLength = reader.uimsbf(16);
        objDii.privateData = new module_descriptors_1.default(reader.readBytesRaw(objDii.privateDataLength)).decode();
        return objDii;
    }
}
...
class TsTableDsmcc {
    ...
    decode() {
        if (this.buffer[1] >> 7 === 1 && TsCrc32.calc(this.buffer) !== 0)
            return null;
        let reader = new reader_1.default(this.buffer);
        let objDsmcc = {};
...
exports.default = TsTableDsmcc;
//# sourceMappingURL=dsmcc.js.map