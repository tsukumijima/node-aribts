...
class TsPacket {
    ...
    decode() {
        const reader = new reader_1.default(this.buffer);
        const objPacket = {};
    ...
    encode(objPacket) {
        const writer = new writer_1.default(this.buffer);
        writer.bslbf(8, 0x47);
        writer.bslbf(1, 0);
